...
export default function ResultPage() {
  ...
  const { event, event_result_number, circuit, results, fastest_lap, type } = result ?? {};
    ...
    <Grid container rowSpacing={3}>
      <Grid item xs={12}>
        <Typography variant="h1" sx={{ marginBottom: 2 }}>
          Result - {isRally ? `${event_result_number.toString().padStart(2, "0")}.` : ""} {circuit.name}
        </Typography>
